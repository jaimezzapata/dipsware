...
<div class="zona_impresion">
	...
	<table border="0" align="center" width="300px">
		<tr>
			<td align="center">
                ...
                <?php echo 'ESTE ES UN BONO DE REGALO' ?><br>
				<?php echo 'TIENES 10 DÍAS PARA REDIMIRLO' ?><br>
			</td>
		</tr>
		<tr>
        ...
        <tr>
			<!--mostramos los datos del cliente -->
			<td>Vendedor: <?php echo $reg->usuario; ?>
			</td>
		</tr>
	</table>
	<br>
	...
	<table border="0" align="center" width="300px">
		...
		while ($regd = $rsptad->fetch_object()) {
		 ...
		 ?>
		<tr>
			<td colspan="3" align="center">N° de articulos: <?php echo $cantidad, "<hr>"; ?> </td>
		</tr>
		<tr>
			<td colspan="3">&nbsp;</td>
		</tr>
		<tr>
			<td colspan="3" align="center">¡Gracias preferirme!</td>
		</tr>
		<tr>
