...
function desactivar(idpersona){
	bootbox.confirm("¿Seguro desea desactivar este Cliente/Proveedor?", function(result){
		if (result) {
...
function activar(idpersona){
	bootbox.confirm("¿Seguro desea activar este Cliente/Proveedor?" , function(result){
		if (result) {
