          ...
          <div class="col-md-12">
            <div class="box">
              ...
              <div class="panel-body table-responsive" id="listadoregistros">
                ...
                <div class="form col-lg-4 col-md-6 col-sm-6 col-xs-12">
                  <label>Cliente</label>
                  <select name="idcliente" id="idcliente" class="form-control selectpicker" data-live-search="true" required>
                  </select>
                </div>
                <div class="form col-lg-2 col-md-6 col-sm-6 col-xs-12">
                  <br>
                  <button class="btn bgVerde colorBlanco" onclick="listar()">Consultar</button>
                </div>
