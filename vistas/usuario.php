          ...
          <div class="col-md-12">
            <div class="box">
              <div class="box-header with-border">
                <h1 class="box-title">Usuarios</h1><hr>
                
                <button class="btn bgVerde colorBlanco" onclick="mostrarform(true)" id="btnagregar">
              ...
              <div class="panel-body" id="formularioregistros">
                <form action="" name="formulario" id="formulario" method="POST">
                  ...
                  <div class="form-group col-lg-6 col-md-6 col-xs-12">
                    ...
                    <input class="form-control" type="text" name="direccion" id="direccion" placeholder="Documento" maxlength="70">
                  </div>
                  <div class="form-group col-lg-6 col-md-6 col-xs-12">
              ...
              <div class="panel-body" id="formulario_clave">
                <form action="" name="formularioc" id="formularioc" method="POST">
                  ...
                  <button class="btn bgVerde colorBlanco" type="submit" id="btnGuardar_clave">
                    <i class="fa fa-save"></i> Guardar
                  </button>
                  <button class="btn bgCafeClaro colorBlanco" onclick="cancelarform_clave()" type="button">
                    <i class="fa fa-arrow-circle-left"></i> Cancelar
                  </button>
                </form>
              </div>
